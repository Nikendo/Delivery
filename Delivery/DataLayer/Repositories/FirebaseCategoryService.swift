...
public final class FirebaseCategoryService: CategoryServiceProtocol {
    private let db = Firestore.firestore()

    public func fetchProducts(for category: Category) async throws -> [Product] {
