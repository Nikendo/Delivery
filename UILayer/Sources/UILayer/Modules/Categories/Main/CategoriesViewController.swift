...
public class CategoriesViewController: UIViewController, CategoriesViewControllerProtocol {
    ...
    private typealias DataSource = UICollectionViewDiffableDataSource<Section, ProductCategory>
    private typealias Snapshot = NSDiffableDataSourceSnapshot<Section, ProductCategory>
    ...
    private func applySnapshot(categories: [ProductCategory], animatingDifferences: Bool = true) {
